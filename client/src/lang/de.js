module.exports = {
    ...
    modMeasureLength: 'Länge',
    modMeasurePerimeter: 'Umfang',
    modMeasureArea: 'Fläche',
    modMeasureCircumference: 'Umfang',
    modMeasureRadius: 'Radius',

    modMeasureLine: 'Linie',
    modMeasurePolygon: 'Polygon',
    modMeasureCircle: 'Kreis',

	modMeasureHeight: 'Höhe',
	modMeasureRaidus: 'Radius',
	modMeasureWidth: 'Breite',
	modMeasureX: 'X',
	modMeasureY: 'Y',
    ...
    modIdentifyClickButton: 'Identifizieren',
    modIdentifyHoverButton: 'Kartenhinweise anzeigen',

    modPopupZoomButton: 'Zu ausgewähltem Objekt zoomen',
