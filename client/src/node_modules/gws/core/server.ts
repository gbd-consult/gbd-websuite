...
class QueuedRequest {
    ...
    abort() {
        // console.log('LOAD:ABORT', this.layerUid)
        if (this.cancel) {
            this.cancel();
        }
        this.end(null);
    ...
    start() {
        // console.log('LOAD:START', this.layerUid);
        ...
        axios.get(this.url, {
            ...
            .then(res => {
                // console.log('LOAD:OK', this.layerUid, res.data.size);
                this.end(res.data)
            })
            .catch(err => {
                // console.log('LOAD:ERROR', this.layerUid, err);
                this.end(null)
            });
    }
