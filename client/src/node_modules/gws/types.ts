...
type LocaleData = api.IntlLocaleData;
...
export interface IMapFeatureLayer extends IMapLayer {
    ...
    clear();
    setStyles(styleNames: StyleNameMap);
...
export interface IStyleManager {
    names: Array<string>;
    at(name: string): IStyle;
    makeMap(src: {[m in FeatureMode]: StyleArg}) : StyleNameMap;
    get(style: StyleArg): IStyle;
    update(name: string, values: api.StyleValues): IStyle | null;
    nameFor(style: StyleArg): string;
    functionFor(style: StyleArg): ol.StyleFunction | null;
    propsFor(style: StyleArg): api.StyleProps | null;
    notifyChange(map: IMapManager, name?: string);
