...
interface SliderProps extends NumericProps {
    vertical?: boolean;
    ...
    render() {
        ...
        return <div {...rootProps}>
            ...
            <div className="uiControlBox">
                ...
                <div className='uiNumberUpDownButton'>
                    <Tracker
                        yValueMin={-1}
                        yValueMax={+1}
                        yValue={0}
...
function formatNumber(n: number, props: NumberInputProps) {

    if (util.empty(n) || Number.isNaN(n))
        return '';
