...
pip3 install argh Babel beautifulsoup4 Fiona lxml Mako MapProxy OWSLib Pillow psutil psycopg2-binary pycountry PyPDF2 pytest pytest-clarity python-ldap PyYAML requests Shapely svgis uWSGI uwsgitop Wand Werkzeug
...
curl -sL 'http://gws-files.gbd-consult.de/gws-welcome-5.2.tar.gz' -o welcome.tar.gz \
