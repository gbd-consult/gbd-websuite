...
class Config(t.WithAccess):
    ...
    meta: t.Optional[gws.base.metadata.Config] = {}  #: application metadata
...
class Object(gws.Object, t.IApplication):
    ...
    def configure(self):
        ...
        p = self.var('meta')
        self.meta: t.MetaData = gws.base.metadata.from_config(p) if p else None
        ...
        self.auth: t.IAuthManager = t.cast(t.IAuthManager, self.create_child(gws.base.auth.Object, self.var('auth', default=t.Data())))
        self.api: t.IApi = t.cast(t.IApi, self.create_child(gws.base.api.Object, self.var('api', default=t.Data())))
    ...
    def find_action(self, action_type, project_uid=None):
        if project_uid:
            project = t.cast(t.IProject, self.root.find('gws.base.project', project_uid))
