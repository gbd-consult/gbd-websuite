...
#         print()
#
#         u = gws.lib.cache.dangling_dirs(root)
#         if u:
...
#     gws.lib.cache.drop(root, layers)
#
#
...
#         layers = _as_list(layers)
#
#     st = gws.lib.cache.status(root, layers)
#
#     if not st:
#         print('no cached layers found')
#         return
...
#             return
#
#         max_time = root.application.var('seeding.maxTime')
#         concurrency = root.application.var('seeding.concurrency')
#         ts = time.time()
#
#         print(f'\nSTART SEEDING (maxTime={max_time} concurrency={concurrency}), ^C ANYTIME TO CANCEL...\n')
#         done = gws.lib.cache.seed(root, layers, max_time, concurrency, levels)
#         print('=' * 40)
