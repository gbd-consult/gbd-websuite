...
def dispatch(
    ...
    if not desc:
        ...
        raise gws.NotFoundError(command_category, command_name)
    ...
    try:
        ...
        raise gws.BadRequestError(command_category, command_name) from exc
...
def _action_object(root, desc, command_category, command_name, project_uid, user):
    ...
    if project_uid:
        ...
        if not project:
            ...
            raise gws.NotFoundError(command_category, command_name, project_uid)
    ...
    if project and project.actionMgr:
        ...
        if obj and not user.can_use(obj):
            ...
            raise gws.ForbiddenError(command_category, command_name, project_uid)
        if obj:
            return obj
    ...
    if obj and not user.can_use(obj):
        ...
        raise gws.ForbiddenError(command_category, command_name)
    if obj:
        return obj
