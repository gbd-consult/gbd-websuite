...
import gws.base.auth.stores.sqlite
...
class Object(gws.Object, t.IAuthManager):
    ...
    def configure(self):
        ...
        self.store = gws.base.auth.stores.sqlite.SessionStore()
        self.store.init()
    ...
    def new_session(self, **kwargs):
        return gws.base.auth.session.Session(**kwargs)
    ...
    def serialize_user(self, user: t.IUser) -> str:
        return gws.lib.json2.to_string(user.provider.user_to_dict(user))
