...
interface BaseListProps extends types.ViewProps {
    ...
    content?: (f: types.IFeature) => React.ReactNode;
    isSelected?: (f: types.IFeature) => boolean;
}

interface ListProps extends BaseListProps {
    leftButton?: (f: types.IFeature) => React.ReactNode;
    rightButton?: (f: types.IFeature) => React.ReactNode;
    withZoom?: boolean;
}
...
// class FeatureList extends list.List<types.IFeature> {
// }
...
export class List extends React.PureComponent<ListProps> {
    render() {
        ...
        return <list.List
            ...
            content={(f: types.IFeature) => this.props.content ? this.props.content(f) : <ui.Text content={f.elements.title}/>}
            uid={f => f.uid}
