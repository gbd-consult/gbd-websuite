...
export class DateInput extends base.Control<DateInputProps> {
    ...
    render() {
        ...
        let parts = {
            D: <NumberInputBox value={dmy.d} disabled={this.props.disabled} whenChanged={v => this.changed('d', v)}/>,
            M: <NumberInputBox value={dmy.m} disabled={this.props.disabled} whenChanged={v => this.changed('m', v)}/>,
            Y: <NumberInputBox value={dmy.y} disabled={this.props.disabled} whenChanged={v => this.changed('y', v)}/>,
        };
