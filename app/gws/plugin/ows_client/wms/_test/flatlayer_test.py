...
import gws.lib.xmlx as x
import gws.lib.jsonx

x.namespace.register(gws.XmlNamespace(xmlns='ms', uri='http://mapserver.gis.umn.edu/mapserver'))

el = x.from_path('/gws-var/www.wms.nrw.de_geobasis_wms_nw_tdom.xml')
el.set('xmlns', 'wms')
tt = el.to_list()
js = gws.lib.jsonx.to_pretty_string(tt)
...
json_string = formatter.serialize(tt)
...
# def test_default_source_layer_is_root():
#
#
#
#
