...
interface SelectProps extends base.InputProps<string> {
    ...
    onInputChange?: (e: React.SyntheticEvent<HTMLInputElement>, callback: (e: React.SyntheticEvent<HTMLInputElement>) => void) => void;
}
    ...
    render() {
        ...
        if (this.props.withSearch) {
            ...
            if(this.props.onInputChange){
                inputProps.onChange = e => this.props.onInputChange(e,(e) => this.onInputChange(e));
            }
            inputValue = this.state.hasFocus ? (this.state.searchText || '') : currentText;
            itemBits = itemVisibleBits(this.props.items, this.state.searchText, this.props.searchAnywhere);
...
function itemVisibleBits(items: Array<ListItem>, text: string, searchAnywhere: boolean = false) {
    if (searchAnywhere) return text ? items.map(it => itemMatchesAnywhere(it, text)) : null;
...
function itemMatchesAnywhere(it: ListItem, text: string): boolean {
    return it.text.toLowerCase().includes(text.toLowerCase())
}
