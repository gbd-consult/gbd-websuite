...
class Object(ows.Base):
    ...
    def configure_metadata(self):
        return gws.extend(
            ...
            inspireMandatoryKeyword=gws.MetaInspireMandatoryKeyword.humanCatalogueViewer,
            inspireResourceType=gws.MetaInspireResourceType.service,
            inspireSpatialDataServiceType=gws.MetaInspireSpatialDataServiceType.discovery,
    ...
    def post_configure(self):
        ...
        for obj in self.root.find_all():
            ...
            if extent and crs:
                meta.extent4326 = gws.lib.extent.transform_to_4326(extent, crs)
                meta.proj = gws.lib.proj.as_proj(crs)
    ...
    def handle(self, req) -> gws.ContentResponse:
