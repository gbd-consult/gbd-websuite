...
export interface IFeatureLayer extends IMapLayer {
...
export type StyleNameMap = {[selector: string]: string};
export type StyleMapArgs = {[selector: string]: StyleArg};
...
export interface IMapManager {
    ...
    readFeature(props: api.FeatureProps): IFeature;
    readFeatures(propsList: Array<api.FeatureProps>): Array<IFeature>;

    featureFromGeometry(geom: ol.geom.Geometry): IFeature;
    featureFromProps(props: api.FeatureProps): IFeature;
    featureListFromProps(propsList: Array<api.FeatureProps>): Array<IFeature>;

    featureProps(feature: IFeature, depth?: number): api.FeatureProps;
...
export interface IFeature {
    ...
    getProps(depth?: number): api.FeatureProps;
    getAttribute(name: string): any;
    getEditedAttribute(name: string): any;

    setProps(props: api.FeatureProps): IFeature;
...
export interface IModelRegistry {
    ...
    getModelForLayer(layer: IMapLayer): IModel|null;
