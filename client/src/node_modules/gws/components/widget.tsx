...
export class Readonly extends Widget {
    render() {
                ...
                document={
                    {
                        ...
                        source: {
                            ...
                            params: {
                                ...
                                featureUid: this.props.feature.uid,
                            }
                        }
                    }
                }
                whenTouched={() => this.props.whenViewButtonTouched(this)}
            />}
...
export class FeatureList extends Widget<FeatureListProps> {
    render() {
        let cc = this.props.controller;
        let field = this.props.field;
        ...
        let buttons = <React.Fragment>
            ...
            {this.props.whenEditButtonTouched && <Cell>
                <ui.Button
                    ...
                    whenTouched={v => this.props.whenEditButtonTouched(this, selectedFeature)}
                />
            </Cell>}
            {this.props.whenUnlinkButtonTouched && <Cell>
                <ui.Button
                    ...
                    disabled={!selectedFeature}
                    whenTouched={v => this.props.whenUnlinkButtonTouched(this, selectedFeature)}
                />
            </Cell>}
            {this.props.whenDeleteButtonTouched && <Cell>
                <ui.Button
                    ...
                    disabled={!selectedFeature}
                    whenTouched={v => this.props.whenDeleteButtonTouched(this, selectedFeature)}
                />
            </Cell>}
...
export class DocumentList extends Widget<FeatureListProps> {
    render() {
        let cc = this.props.controller;
        let field = this.props.field;
            ...
            documents.push(
                {
                    ...
                    source: {
                        ...
                        params: {
                            featureUid: fe.uid,
                            fieldName: this.props.options['fileFieldName'],
                            modelUid: fe.model.uid,
...
export class FeatureSelect extends Widget {
    render() {
        let cc = this.props.controller;
        let field = this.props.field;
