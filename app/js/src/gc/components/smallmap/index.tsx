...
interface SmallMapProps extends gc.types.ViewProps {
...
export class SmallMap extends React.Component<SmallMapProps, SmallMapState> {
    ...
    smallMap: gc.types.IMapManager | null = null;
    mainMap: gc.types.IMapManager;
    ...
    async init() {
        ...
        //     this.app.project.overviewMap.resolutions = OSM_SCALES.map(s => gc.lib.scale2res(s))
        //     this.app.project.overviewMap.rootLayer.resolutions = OSM_SCALES.map(s => gc.lib.scale2res(s))
        // }

        this.mainMap = this.props.controller.map;

        this.smallMap = new gc.MapManager(this.app, false);
    ...
    setMapTarget(div) {
        ...
        if (this.props.boxSize) {
            ...
            let h = gc.lib.clamp(div.offsetWidth / f, MIN_MAP_HEIGHT, MAX_MAP_HEIGHT);
