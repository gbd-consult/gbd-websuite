...
_1x1_JPG = b'\xff\xd8\xff\xdb\x00CC?\x00?\xf0\x7f\xff\xd9'
...
class Object(gws.ActionObject):
    ...
    def _image_url(self, req, r, n):
        if r.get(f'image{n}'):
            return req.reversed_url(f"cmd=georisksHttpGetReportImage&reportUid={r['id']}&image={n}.jpg")

    def http_get_report_image(self, req, p) -> t.HttpResponse:
        # params are reportUid, image (1.._MAX_IMAGES)

        image = gws.as_int(req.params.get('image', '').split('.')[0]) or 1
