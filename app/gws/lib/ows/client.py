...
def prepared_search(**kwargs) -> PreparedOwsSearch:
    ...
    ps.request_crs = ps.request_crs or gws.lib.gis.util.best_crs(
        our_crs,
    ...
    ps.axis = gws.lib.gis.util.best_axis(ps.request_crs, ps.protocol, ps.protocol_version, ps.inverted_crs)
