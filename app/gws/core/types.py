...
class IUser(IObject, Protocol):
    ...
    def acquire(self, uid: str, classref: ClassRef = None, access: Access = Access.use) -> Optional[IObject]: ...

    def require(self, uid: str, classref: ClassRef = None, access: Access = Access.use) -> IObject: ...
