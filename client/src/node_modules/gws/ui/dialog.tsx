...
export class Popup extends React.PureComponent<DialogProps> {
    ...
    componentDidMount() {
        util.nextTick(() => this.ref.current && (this.ref.current.className += ' isActive'));
    }
    ...
    render() {
        ...
        return <div className='uiPopupBackdrop' onClick={close} ref={this.ref}>
            <div {...util.cls('uiPopup', this.props.className)} style={this.props.style}>
                {this.props.children}
            </div>
        </div>
    }
...
export class Panel extends React.PureComponent<DialogProps> {
    render() {
        return <div {...util.cls('uiPanel', this.props.whenClosed && 'withCloseButton', this.props.className)}>
            {this.props.whenClosed && <IconButton
