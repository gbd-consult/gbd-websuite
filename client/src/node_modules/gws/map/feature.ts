...
export class FeatureCollection implements types.IMapFeatureCollection {
    features: Array<types.IFeature>

    constructor(features?: Array<types.IFeature>) {
...
export class Feature implements types.IFeature {
    ...
    constructor(map) {
        this.map = map;
        this.uid = tools.uniqId('_feature_');
    }
    ...
    setProps(props) {
        ...
        if (this.layerUid)
            this.layer = this.map.getLayer(this.layerUid) as types.IFeatureLayer;
    ...
    get isDirty() {
        return !tools.empty(this.editedAttributes);
    }
