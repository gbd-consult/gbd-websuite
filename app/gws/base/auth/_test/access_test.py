...
def test_access_direct():
    ...
    obj = gws.Data(access=gws.u.parse_acl('allow a'))
    assert u.can_use(obj) is True

    obj = gws.Data(access=gws.u.parse_acl('deny a'))
    assert u.can_use(obj) is False

    obj = gws.Data(access=gws.u.parse_acl('deny x, allow b'))
    assert u.can_use(obj) is True

    obj = gws.Data(access=gws.u.parse_acl('deny x, deny b'))
    assert u.can_use(obj) is False

    obj = gws.Data(access=gws.u.parse_acl('deny x'))
    assert u.can_use(obj) is False
...
def test_access_context():
    ...
    x = gws.Data(access=gws.u.parse_acl('allow x'))
    y = gws.Data(access=gws.u.parse_acl('allow y'))
    z = gws.Data(access=gws.u.parse_acl('allow z'))
    a = gws.Data(access=gws.u.parse_acl('allow a'))
