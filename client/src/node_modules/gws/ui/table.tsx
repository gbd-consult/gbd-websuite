...
export class Table extends base.Pure<TableProps> {
    ...
    topRow(p) {
        ...
        return <div style={sBox} className="uiTableHead">
            {p.fixedColumns > 0 && <div style={sLeft}>
                <Grid>
                    <Row>
                        {p.headers.slice(0, p.fixedColumns).map((val, c) => this.cell(p, c, val))}
                    </Row>
                </Grid>
            </div>}
            <div style={sRight} ref={this.topRef}>
                <Grid>
                    <Row>
                        {p.headers.slice(p.fixedColumns).map((val, c) => this.cell(p, c + p.fixedColumns, val))}
                    </Row>
                </Grid>
            </div>
        </div>
