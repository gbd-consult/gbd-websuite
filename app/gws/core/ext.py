...
class object:
    ...
    class modelValue(_tag): extName = 'gws.ext.object.modelValue'
...
class config:
    ...
    class modelValue(_tag): extName = 'gws.ext.config.modelValue'
...
class props:
    ...
    class modelValue(_tag): extName = 'gws.ext.props.modelValue'
