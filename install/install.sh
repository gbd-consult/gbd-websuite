...
pip3 install argh Babel beautifulsoup4 Fiona lxml Mako MapProxy OWSLib Pillow psutil psycopg2-binary pycountry PyPDF2 pytest python-ldap PyYAML requests Shapely svgis uWSGI uwsgitop Wand Werkzeug
