        ...
        return <sidebar.Tab>
            ...
            <sidebar.TabFooter>
                <sidebar.AuxToolbar>
                    <Cell>
                        <sidebar.AuxButton
                            {...gws.lib.cls('modBplanImportAuxButton')}
                    ...
                    <Cell>
                        <sidebar.AuxButton
                            {...gws.lib.cls('modBplanMetaAuxButton')}
                    ...
                    <Cell>
                        <sidebar.AuxButton
                            {...gws.lib.cls('modBplanCSVAuxButton')}
                    ...
                    <Cell>
                        <sidebar.AuxButton
                            {...gws.lib.cls('modBplanInfoAuxButton')}
...
class BplanController extends gws.Controller {
    ...
    async submitUpload() {
        ...
        let buf: Uint8Array = await gws.lib.readFile(files[0]);
