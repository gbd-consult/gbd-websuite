...
class Object(gws.ActionObject):
    ...
    def api_print(self, req: t.WebRequest, p: pt.PrintParams) -> pt.PrinterResponse:
    ...
    def api_snapshot(self, req: t.WebRequest, p: pt.PrintParams) -> pt.PrinterResponse:
        """Start a backround snapshot job"""

        req.require_project(p.projectUid)
        return service.start_job(req, p)

    def api_query(self, req: t.WebRequest, p: pt.PrinterQueryParams) -> pt.PrinterResponse:
        """Query the print job status"""

        return service.query_job(req, p)

    def api_cancel(self, req: t.WebRequest, p: pt.PrinterQueryParams) -> pt.PrinterResponse:
        """Cancel a print job"""

        return service.cancel_job(req, p)

    def http_get_result(self, req: t.WebRequest, p: pt.PrinterQueryParams) -> t.HttpResponse:
