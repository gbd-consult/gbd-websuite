...
interface ElementProps extends gc.types.ViewProps {
    feature: gc.types.IFeature;
    element: string;
    className?: string;
}

interface BaseListProps extends gc.types.ViewProps {
    features: Array<gc.types.IFeature>;
    content?: (f: gc.types.IFeature) => React.ReactNode;
    isSelected?: (f: gc.types.IFeature) => boolean;
}

interface ListProps extends BaseListProps {
    leftButton?: (f: gc.types.IFeature) => React.ReactNode;
    rightButton?: (f: gc.types.IFeature) => React.ReactNode;
    withZoom?: boolean;
}
...
interface TaskButtonProps extends gc.types.ViewProps {
    feature: gc.types.IFeature;
    source?: string;
}
