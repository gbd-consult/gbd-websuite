...
def parse(srv: t.ServiceInterface, xml):
    ...
    srv.meta = t.MetaData(u.get_meta(el.first('ServiceIdentification')))
    srv.meta.contact = t.MetaContact(u.get_meta_contact(el.first('ServiceProvider.ServiceContact')))
