...
NAMESPACES = {
    'ac-mf': (
        'http://inspire.ec.europa.eu/schemas/ac-mf/4.0',
        'http://inspire.ec.europa.eu/schemas/ac-mf/4.0/AtmosphericConditionsandMeteorologicalGeographicalFeatures.xsd'
    ),
    'act-core': (
        'http://inspire.ec.europa.eu/schemas/act-core/4.0',
        'http://inspire.ec.europa.eu/schemas/act-core/4.0/ActivityComplex_Core.xsd'
    ),
    'ad': (
        'http://inspire.ec.europa.eu/schemas/ad/4.0',
        'http://inspire.ec.europa.eu/schemas/ad/4.0/Addresses.xsd'
    ),
    'af': (
        'http://inspire.ec.europa.eu/schemas/af/4.0',
        'http://inspire.ec.europa.eu/schemas/af/4.0/AgriculturalAndAquacultureFacilities.xsd'
    ),
    'am': (
        'http://inspire.ec.europa.eu/schemas/am/4.0',
        'http://inspire.ec.europa.eu/schemas/am/4.0/AreaManagementRestrictionRegulationZone.xsd'
    ),
    'au': (
    ...
    'base2': (
        ...
        'http://inspire.ec.europa.eu/schemas/base2/2.0/BaseTypes2.xsd'
    ),
    'br': (
        'http://inspire.ec.europa.eu/schemas/br/4.0',
    ...
    'bu': (
        'http://inspire.ec.europa.eu/schemas/bu/0.0',
        'http://inspire.ec.europa.eu/schemas/bu/0.0/Buildings.xsd'
    ),
    'common': (
    ...
    'cvbase': (
        'http://inspire.ec.europa.eu/schemas/cvbase/2.0',
        'http://inspire.ec.europa.eu/schemas/cvbase/2.0/CoverageBase.xsd'
    ),
    'cvgvp': (
        'http://inspire.ec.europa.eu/schemas/cvgvp/0.1',
        'http://inspire.ec.europa.eu/schemas/cvgvp/0.1/CoverageGVP.xsd'
    ),
    'ef': (
    ...
    'el-bas': (
        'http://inspire.ec.europa.eu/schemas/el-bas/4.0',
        'http://inspire.ec.europa.eu/schemas/el-bas/4.0/ElevationBaseTypes.xsd'
    ),
    'el-cov': (
        'http://inspire.ec.europa.eu/schemas/el-cov/4.0',
        'http://inspire.ec.europa.eu/schemas/el-cov/4.0/ElevationGridCoverage.xsd'
    ),
    'el-tin': (
        'http://inspire.ec.europa.eu/schemas/el-tin/4.0',
        'http://inspire.ec.europa.eu/schemas/el-tin/4.0/ElevationTin.xsd'
    ),
    'el-vec': (
        'http://inspire.ec.europa.eu/schemas/el-vec/4.0',
        'http://inspire.ec.europa.eu/schemas/el-vec/4.0/ElevationVectorElements.xsd'
    ),
    'elu': (
        'http://inspire.ec.europa.eu/schemas/elu/4.0',
        'http://inspire.ec.europa.eu/schemas/elu/4.0/ExistingLandUse.xsd'
    ),
    'er-b': (
        'http://inspire.ec.europa.eu/schemas/er-b/4.0',
        'http://inspire.ec.europa.eu/schemas/er-b/4.0/EnergyResourcesBase.xsd'
    ),
    'er-c': (
        'http://inspire.ec.europa.eu/schemas/er-c/4.0',
        'http://inspire.ec.europa.eu/schemas/er-c/4.0/EnergyResourcesCoverage.xsd'
    ),
    'er-v': (
        'http://inspire.ec.europa.eu/schemas/er-v/4.0',
        'http://inspire.ec.europa.eu/schemas/er-v/4.0/EnergyResourcesVector.xsd'
    ),
    'er': (
        'http://inspire.ec.europa.eu/schemas/er/0.0',
        'http://inspire.ec.europa.eu/schemas/er/0.0/EnergyResources.xsd'
    ),
    'gaz': (
        'http://inspire.ec.europa.eu/schemas/gaz/3.2',
        'http://inspire.ec.europa.eu/schemas/gaz/3.2/Gazetteer.xsd'
    ),
    'ge-core': (
        'http://inspire.ec.europa.eu/schemas/ge-core/4.0',
        'http://inspire.ec.europa.eu/schemas/ge-core/4.0/GeologyCore.xsd'
    ),
    'ge': (
        'http://inspire.ec.europa.eu/schemas/ge/0.0',
        'http://inspire.ec.europa.eu/schemas/ge/0.0/Geology.xsd'
    ),
    'ge_gp': (
        'http://inspire.ec.europa.eu/schemas/ge_gp/4.0',
        'http://inspire.ec.europa.eu/schemas/ge_gp/4.0/GeophysicsCore.xsd'
    ),
    'ge_hg': (
        'http://inspire.ec.europa.eu/schemas/ge_hg/4.0',
        'http://inspire.ec.europa.eu/schemas/ge_hg/4.0/HydrogeologyCore.xsd'
    ),
    'gelu': (
        'http://inspire.ec.europa.eu/schemas/gelu/4.0',
        'http://inspire.ec.europa.eu/schemas/gelu/4.0/GriddedExistingLandUse.xsd'
    ),
    'geoportal': (
        'http://inspire.ec.europa.eu/schemas/geoportal/1.0',
        'http://inspire.ec.europa.eu/schemas/geoportal/1.0/geoportal.xsd'
    ),
    'gn': (
    ...
    'hb': (
        'http://inspire.ec.europa.eu/schemas/hb/4.0',
        'http://inspire.ec.europa.eu/schemas/hb/4.0/HabitatsAndBiotopes.xsd'
    ),
    'hh': (
        'http://inspire.ec.europa.eu/schemas/hh/4.0',
    ...
    'hy-p': (
        'http://inspire.ec.europa.eu/schemas/hy-p/4.0',
        'http://inspire.ec.europa.eu/schemas/hy-p/4.0/HydroPhysicalWaters.xsd'
    ),
    'hy': (
        'http://inspire.ec.europa.eu/schemas/hy/4.0',
        'http://inspire.ec.europa.eu/schemas/hy/4.0/HydroBase.xsd'
    ),
    'inspire_dls': (
    ...
    'inspire_ds': (
        ...
        'http://inspire.ec.europa.eu/schemas/inspire_ds/1.0/inspire_ds.xsd'
    ),
    'inspire_vs': (
    ...
    'lc': (
        'http://inspire.ec.europa.eu/schemas/lc/0.0',
        'http://inspire.ec.europa.eu/schemas/lc/0.0/LandCover.xsd'
    ),
    'lcn': (
        'http://inspire.ec.europa.eu/schemas/lcn/4.0',
        'http://inspire.ec.europa.eu/schemas/lcn/4.0/LandCoverNomenclature.xsd'
    ),
    'lcr': (
        'http://inspire.ec.europa.eu/schemas/lcr/4.0',
        'http://inspire.ec.europa.eu/schemas/lcr/4.0/LandCoverRaster.xsd'
    ),
    'lcv': (
        'http://inspire.ec.europa.eu/schemas/lcv/4.0',
        'http://inspire.ec.europa.eu/schemas/lcv/4.0/LandCoverVector.xsd'
    ),
    'lunom': (
        'http://inspire.ec.europa.eu/schemas/lunom/4.0',
        'http://inspire.ec.europa.eu/schemas/lunom/4.0/LandUseNomenclature.xsd'
    ),
    'mr-core': (
        'http://inspire.ec.europa.eu/schemas/mr-core/4.0',
        'http://inspire.ec.europa.eu/schemas/mr-core/4.0/MineralResourcesCore.xsd'
    ),
    'mu': (
        'http://inspire.ec.europa.eu/schemas/mu/3.0rc3',
        'http://inspire.ec.europa.eu/schemas/mu/3.0rc3/MaritimeUnits.xsd'
    ),
    'net': (
        'http://inspire.ec.europa.eu/schemas/net/4.0',
        'http://inspire.ec.europa.eu/schemas/net/4.0/Network.xsd'
    ),
    'nz-core': (
        'http://inspire.ec.europa.eu/schemas/nz-core/4.0',
        'http://inspire.ec.europa.eu/schemas/nz-core/4.0/NaturalRiskZonesCore.xsd'
    ),
    'nz': (
        'http://inspire.ec.europa.eu/schemas/nz/0.0',
        'http://inspire.ec.europa.eu/schemas/nz/0.0/NaturalRiskZones.xsd'
    ),
    'of': (
        'http://inspire.ec.europa.eu/schemas/of/4.0',
        'http://inspire.ec.europa.eu/schemas/of/4.0/OceanFeatures.xsd'
    ),
    'oi': (
        'http://inspire.ec.europa.eu/schemas/oi/4.0',
        'http://inspire.ec.europa.eu/schemas/oi/4.0/Orthoimagery.xsd'
    ),
    'omop': (
        'http://inspire.ec.europa.eu/schemas/omop/3.0',
        'http://inspire.ec.europa.eu/schemas/omop/3.0/ObservableProperties.xsd'
    ),
    'omor': (
        'http://inspire.ec.europa.eu/schemas/omor/3.0',
        'http://inspire.ec.europa.eu/schemas/omor/3.0/ObservationReferences.xsd'
    ),
    'ompr': (
        'http://inspire.ec.europa.eu/schemas/ompr/3.0',
        'http://inspire.ec.europa.eu/schemas/ompr/3.0/Processes.xsd'
    ),
    'omso': (
    ...
    'pd': (
        'http://inspire.ec.europa.eu/schemas/pd/4.0',
        'http://inspire.ec.europa.eu/schemas/pd/4.0/PopulationDistributionDemography.xsd'
    ),
    'pf': (
        'http://inspire.ec.europa.eu/schemas/pf/4.0',
        'http://inspire.ec.europa.eu/schemas/pf/4.0/ProductionAndIndustrialFacilities.xsd'
    ),
    'plu': (
        'http://inspire.ec.europa.eu/schemas/plu/4.0',
    ...
    'sd': (
        'http://inspire.ec.europa.eu/schemas/sd/4.0',
        'http://inspire.ec.europa.eu/schemas/sd/4.0/SpeciesDistribution.xsd'
    ),
    'selu': (
        'http://inspire.ec.europa.eu/schemas/selu/4.0',
        'http://inspire.ec.europa.eu/schemas/selu/4.0/SampledExistingLandUse.xsd'
    ),
    'so': (
        'http://inspire.ec.europa.eu/schemas/so/4.0',
        'http://inspire.ec.europa.eu/schemas/so/4.0/Soil.xsd'
    ),
    'sr': (
        'http://inspire.ec.europa.eu/schemas/sr/4.0',
        'http://inspire.ec.europa.eu/schemas/sr/4.0/SeaRegions.xsd'
    ),
    'su-core': (
        'http://inspire.ec.europa.eu/schemas/su-core/4.0',
        'http://inspire.ec.europa.eu/schemas/su-core/4.0/StatisticalUnitCore.xsd'
    ),
    'su-grid': (
        'http://inspire.ec.europa.eu/schemas/su-grid/4.0',
        'http://inspire.ec.europa.eu/schemas/su-grid/4.0/StatisticalUnitGrid.xsd'
    ),
    'su-vector': (
        'http://inspire.ec.europa.eu/schemas/su-vector/4.0',
        'http://inspire.ec.europa.eu/schemas/su-vector/4.0/StatisticalUnitVector.xsd'
    ),
    'su': (
        'http://inspire.ec.europa.eu/schemas/su/0.0',
        'http://inspire.ec.europa.eu/schemas/su/0.0/StatisticalUnits.xsd'
    ),
    'tn-a': (
        'http://inspire.ec.europa.eu/schemas/tn-a/4.0',
        'http://inspire.ec.europa.eu/schemas/tn-a/4.0/AirTransportNetwork.xsd'
    ),
    'tn-c': (
        'http://inspire.ec.europa.eu/schemas/tn-c/4.0',
        'http://inspire.ec.europa.eu/schemas/tn-c/4.0/CableTransportNetwork.xsd'
    ),
    'tn-ra': (
        'http://inspire.ec.europa.eu/schemas/tn-ra/4.0',
        'http://inspire.ec.europa.eu/schemas/tn-ra/4.0/RailwayTransportNetwork.xsd'
    ),
    'tn-ro': (
    ...
    'tn-w': (
        'http://inspire.ec.europa.eu/schemas/tn-w/4.0',
        'http://inspire.ec.europa.eu/schemas/tn-w/4.0/WaterTransportNetwork.xsd'
    ),
    'tn': (
        'http://inspire.ec.europa.eu/schemas/tn/4.0',
        'http://inspire.ec.europa.eu/schemas/tn/4.0/CommonTransportElements.xsd'
    ),
    'ugs': (
        'http://inspire.ec.europa.eu/schemas/ugs/0.0',
        'http://inspire.ec.europa.eu/schemas/ugs/0.0/UtilityAndGovernmentalServices.xsd'
    ),
    'us-emf': (
        'http://inspire.ec.europa.eu/schemas/us-emf/4.0',
        'http://inspire.ec.europa.eu/schemas/us-emf/4.0/EnvironmentalManagementFacilities.xsd'
    ),
    'us-govserv': (
        'http://inspire.ec.europa.eu/schemas/us-govserv/4.0',
        'http://inspire.ec.europa.eu/schemas/us-govserv/4.0/GovernmentalServices.xsd'
    ),
    'us-net-common': (
        'http://inspire.ec.europa.eu/schemas/us-net-common/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-common/4.0/UtilityNetworksCommon.xsd'
    ),
    'us-net-el': (
        'http://inspire.ec.europa.eu/schemas/us-net-el/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-el/4.0/ElectricityNetwork.xsd'
    ),
    'us-net-ogc': (
        'http://inspire.ec.europa.eu/schemas/us-net-ogc/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-ogc/4.0/OilGasChemicalsNetwork.xsd'
    ),
    'us-net-sw': (
        'http://inspire.ec.europa.eu/schemas/us-net-sw/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-sw/4.0/SewerNetwork.xsd'
    ),
    'us-net-tc': (
        'http://inspire.ec.europa.eu/schemas/us-net-tc/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-tc/4.0/TelecommunicationsNetwork.xsd'
    ),
    'us-net-th': (
        'http://inspire.ec.europa.eu/schemas/us-net-th/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-th/4.0/ThermalNetwork.xsd'
    ),
    'us-net-wa': (
        'http://inspire.ec.europa.eu/schemas/us-net-wa/4.0',
        'http://inspire.ec.europa.eu/schemas/us-net-wa/4.0/WaterNetwork.xsd'
    ),
    'wfd': (
        'http://inspire.ec.europa.eu/schemas/wfd/0.0',
        'http://inspire.ec.europa.eu/schemas/wfd/0.0/WaterFrameworkDirective.xsd'
    ),
}
