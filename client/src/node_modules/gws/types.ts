...
export interface ModifyInteractionOptions {
    ...
    whenStarted?: (olfs: Array<ol.Feature>) => void;
}
...
export interface IMapManager {
    ...
    setInteractions(intrs: Array<ol.interaction.Interaction | string>);
    pushInteractions();
    popInteractions();

    drawInteraction(opts: DrawInteractionOptions);
    modifyInteraction(opts: ModifyInteractionOptions);
    pointerInteraction(opts: Dict);
    ...
    printParams(boxRect: ClientRect | null, template: api.TemplateProps, quality: number): Promise<api.PrintParams>;
    searchParams(keyword: string, geometry: ol.geom.Geometry | null): Promise<api.SearchParams>;
}
