...
class RawList extends React.PureComponent<RawListProps> {
    render() {
        return <div className='uiList'>
            <div className='uiListBox'>
                {this.props.items.map(p =>
                    <div
                        className={util.className('uiListItem', p.level && 'uiListItemLevel' + p.level)}
                        key={p.value}
